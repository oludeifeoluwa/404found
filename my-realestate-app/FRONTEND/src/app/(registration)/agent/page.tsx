...
export default function AgentRegistrationPage() {
  ...
  const validateStep = () => {
    ...
    if (step === 1) {
      ...
      if (!formData.agencyName) newErrors.agencyName = 'Agency/Organization name is required';
    } else if (step === 3) {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">    
        ...
        <div className="mt-8 space-y-6">
          ...
          {step === 4 && (
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-900">Add Profile Picture</h3>
                <p className="text-sm text-gray-500">Build your profile</p>
              </div>
              <div className={`mt-4 flex justify-center px-6 pt-5 pb-6 border-2 ${
          ...
          <div className="flex justify-between">
            ...
            <button
              type="button"
              onClick={handleNext}
              className={`${step > 1 ? 'w-2/3 ml-4' : 'w-full'} flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-blue-950 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
            >
